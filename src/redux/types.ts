...
export const UPDATE_JOB_POST_REQUEST = 'UPDATE_JOBPOST_REQUEST'
export const UPDATE_JOB_POST_SUCCESS = 'UPDATE_JOBPOST_SUCCESS'
export const UPDATE_JOB_POST_FAIL = 'UPDATE_JOBPOST_FAIL'
